  ...
  myList.map(element => {
    ...
    cell.innerHTML = `<ul class="dots-menu">
      <li class="nav-item drop-right">
        ...
        <ul>
          <li class="nav-item">
            <a href="#" class="nav-link" onclick="{document.getElementById('idusua').value='${element.IDUSUA}', document.getElementById('msgdes').innerHTML ='<p>${element.NOMUSU}</p>'}" data-bs-toggle="modal" data-bs-target="#modal-desmatr">
...
elemDel.setAttribute('action', `/admin/cursos/matriculas/usuarios/delete?part=${getCookie('filtro1')}`)
