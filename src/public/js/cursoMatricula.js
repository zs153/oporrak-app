  ...
  myList.map(element => {
    ...
    cell.innerHTML = `<ul class="dots-menu">
      <li class="nav-item drop-right">
        ...
        <ul>
          <li class="nav-item">
            <a href="/admin/matriculas/cursos/edit/${matricula.IDMATR}/${element.IDCURS}" class="nav-link">
              <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
          ...
          <li class="nav-item">
            <a href="/admin/matriculas/cursos/usuarios/${matricula.IDMATR}/${element.IDCURS}" class="nav-link">
          ...
          <div class="nav-divider"></div>
          <li class="nav-item">
            <a href="/admin/matriculas/cursos/turnos/${matricula.IDMATR}/${element.IDCURS}" class="nav-link">
