/*! oporrak 2023-05-13 */
document.querySelectorAll(".sortable th").forEach(i=>{i.addEventListener("click",()=>{var e=i.parentElement.parentElement.parentElement,t=Array.prototype.indexOf.call(i.parentElement.children,i),n=i.classList.contains("th-sort-asc");sortTableByColumn(e,t,!n)})});const sortTableByColumn=(e,n,t=!0)=>{const i=t?1:-1;var l,s=e.tBodies[0];for(l of Array.from(s.querySelectorAll("tr")).sort((e,t)=>{e=e.cells[n].textContent;return t.cells[n].textContent<e?i:-1*i}))s.appendChild(l);e.querySelectorAll("th").forEach(e=>e.classList.remove("th-sort-asc","th-sort-desc")),e.querySelector(`th:nth-child(${n+1})`).classList.toggle("th-sort-asc",t),e.querySelector(`th:nth-child(${n+1})`).classList.toggle("th-sort-desc",!t)},buildTable=e=>{const i=document.getElementById("table-body");e=e.querySet;i.innerHTML="",e.map(e=>{var t=document.createElement("tr");let n=document.createElement("td");n.classList.add("w-4"),n.innerHTML=`<div class="align-items-center">
      <span class="avatar avatar-rounded bg-green-lt">
        <h6>${e.IDCURS}</h6>
      </span>
    </div>`,t.appendChild(n),(n=document.createElement("td")).innerHTML=`<div class="d-flex align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${e.DESCUR}</div>
      </div>
    </div>`,t.appendChild(n),(n=document.createElement("td")).classList.add("w-9"),n.innerHTML=`<div class="d-flex align-items-center">
      <div class="flex-fill">
      ...
      <li class="nav-item drop-right">
        ...
        <ul>
          <li class="nav-item">
            <a href="/admin/cursos/edit/${e.IDCURS}?part=${getCookie("filtro")}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="/admin/cursos/matriculas/${e.IDCURS}?part=${getCookie("filtro")}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="/admin/cursos/turnos/${e.IDCURS}?part=${getCookie("filtro")}" class="nav-link">
          ...
          <div class="nav-divider"></div>
          <li class="nav-item">
            <a href="/admin/cursos/usuarios/${e.IDCURS}?part=${getCookie("filtro")}" class="nav-link">
    ...
    </ul>`,t.appendChild(n),i.appendChild(t)}),createPages()},createPages=()=>{let e="<ul>";hasPrevCursos?e+="<li class='page-item previous no'><a href='/admin/cursos?cursor="+JSON.stringify(cursor)+"&part="+document.getElementById("buscarCursoBox").value+"&dir=prev' class='nav-link'>&#9664 Anterior</a>":e+="<li><a href='#' class='nav-link disabled'>&#9664 Anterior</a>",hasNextCursos?e+="<li class='page-item next no'><a href='/admin/cursos?cursor="+JSON.stringify(cursor)+"&part="+document.getElementById("buscarCursoBox").value+"&dir=next' class='nav-link'>Siguiente &#9654</a>":e+="<li><a href='#' class='nav-link disabled'>Siguiente &#9654</a>",e+="</ul>",document.getElementById("pagination-wrapper").innerHTML=e};