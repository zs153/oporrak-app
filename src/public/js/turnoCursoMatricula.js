...
const buildTable = (state) => {
  ...
  myList.map(element => {
    ...
    cell.innerHTML = `<div class="d-flex align-items-center">
      <div class="flex-fill">
        <div class="font-weight-medium">${element.STRINI} - ${element.STRFIN}</div>
      </div>
    </div>`
    row.appendChild(cell)
    ...
    cell.innerHTML = `<ul class="dots-menu">
        <li class="nav-item drop-right">
          ...
          <ul>
            <li class="nav-item">
              <a href="/admin/matriculas/cursos/turnos/edit/${matricula.IDMATR}/${curso.IDCURS}/${element.IDTURN}" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            ...
            <li class="nav-item">
              <a href="#" class="nav-link" onclick="{document.getElementById('idturn').value ='${element.IDTURN}', document.getElementById('msgbor').innerHTML ='<p>${element.DESTUR}</p>'}" data-bs-toggle="modal" data-bs-target="#modal-borrar">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-inline me-2" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            ...
            <li class="nav-item">
              <a href="/admin/matriculas/cursos/turnos/usuarios/${matricula.IDMATR}/${curso.IDCURS}/${element.IDTURN}" class="nav-link">
